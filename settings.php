...
use core\setting\type\path_directory;
...
if ($hassiteconfig) {
    $temp = new core\setting\part\page('suspensionsettings', new lang_string('suspensionsettings', 'tool_usersuspension'));
    // Header.
    ...
    // Default settings.
    $temp->add(new heading(
        'tool_usersuspension_suspensionsettings',
    ...
    $temp->add(new checkbox(
        'tool_usersuspension/enablecleanlogs',
    ...
    $temp->add(new duration(
        'tool_usersuspension/cleanlogsafter',
    ...
    $temp->add(new checkbox(
        'tool_usersuspension/send_suspend_email',
    ...
    $temp->add(new checkbox(
        'tool_usersuspension/enableunsuspendfromfolder',
    ...
    // Upload folder.
    $temp->add(new path_directory(
        'tool_usersuspension/uploadfolder',
        get_string('setting:uploadfolder', 'tool_usersuspension'),
        get_string('setting:desc:uploadfolder', 'tool_usersuspension') . '<br/>' .
        get_string('form:static:uploadfile:desc', 'tool_usersuspension'),
        ''
    ));
    $temp->add(new text(
        'tool_usersuspension/uploadfilename',
        get_string('setting:uploadfilename', 'tool_usersuspension'),
        get_string('setting:desc:uploadfilename', 'tool_usersuspension'),
        ''
    ));
    $temp->add(new text(
        'tool_usersuspension/unsuspenduploadfilename',
    ...
    $temp->add(new duration(
        'tool_usersuspension/uploaddetect_interval',
    ...
    $temp->add(new select(
        'tool_usersuspension/csvdelimiter',
    ...
    $temp->add(new heading(
        'tool_usersuspension_csvexample',
        '',
    ...
    $temp->add(new heading(
        'tool_usersuspension_suspensionsettingssmartdetect',
    ...
    $temp->add(new checkbox(
        'tool_usersuspension/enablesmartdetect',
    ...
    // Checking interval.
    $temp->add(new duration(
        'tool_usersuspension/smartdetect_interval',
    ...
    $temp->add(new duration(
        'tool_usersuspension/smartdetect_suspendafter',
    ...
    $temp->add(new duration(
        'tool_usersuspension/smartdetect_warninginterval',
    ...
    $temp->add(new checkbox(
        'tool_usersuspension/send_delete_email',
    ...
    $temp->add(new duration(
        'tool_usersuspension/cleanup_interval',
    ...
    $temp->add(new duration(
        'tool_usersuspension/cleanup_deleteafter',
    ...
    $ADMIN->add('users', new core\setting\page\externalpage(
        'toolusersuspension',
        get_string('pluginname', 'tool_usersuspension'),
        "{$CFG->wwwroot}/{$CFG->admin}/tool/usersuspension/view/exclude.php",
        'moodle/user:update'
    ));
}
